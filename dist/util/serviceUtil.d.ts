...
declare abstract class ServiceUtil {
    protected static forParents(alias: string, parentEntities: ParentEntity[], action: (alias: string, parent: ParentEntity, serviceOptions: ServiceOptions<any>) => void, serviceOptions: ServiceOptions<any>): void;
    protected static forChilds(alias: string, childEntities: ChildEntity[], action: (alias: string, child: ChildEntity, serviceOptions: ServiceOptions<any>) => void, serviceOptions: ServiceOptions<any>): void;
